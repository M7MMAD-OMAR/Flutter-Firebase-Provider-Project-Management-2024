...
String formatDateTime(DateTime dateTime) {
  ...
  if (dateTime.year == now.year &&
    ...
    return "${Constants.today_key.tr} ${DateFormat('h:mm a').format(dateTime)}";
  } else {
