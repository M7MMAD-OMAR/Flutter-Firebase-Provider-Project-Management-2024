          ...
          Padding(
            ...
            child: SafeArea(
              child: TaskezAppHeader(
                title:
                    "${Constants.task_key.tr} :${widget.fatherTaskModel.name?.toUpperCase()}  ${Constants.tasks_key.tr}",
                widget: MySearchBarWidget(
                  searchWord:
                      "${widget.fatherTaskModel.name?.toUpperCase()} ${Constants.tasks_key.tr}",
          ...
          addLateTask: (
            ...
            try {
              ...
              CustomSnackBar.showSuccess(
                  "${Constants.the_task_key} ${userTaskModel.name} ${Constants.added_successfully_key}");
