                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${widget.completed.toInt()} ${Constants.out_of_key.tr} ${widget.all.toInt()} ${Constants.is_completed_key.tr}',
                          ...
                          //AppSpaces.verticalSpace10,
                          buildLabel(
                              "${Constants.description_key.tr} : ${widget.taskModel.description}"),
                          buildLabel(
                              "${Constants.start_date_key.tr}:${formatDateTime(widget.taskModel.startDate)}"),
                          buildLabel(
                              "${Constants.end_date_key.tr}:${formatDateTime(widget.taskModel.endDate!)}"),
                        ],
                      ),
                    ),
                  ],
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppSpaces.verticalSpace10,
                          Text(
                            '${widget.completed.toInt()}  ${widget.all.toInt()}  ${Constants.is_completed_key.tr}',
                            // Use the rating property of taskModel
                            style: GoogleFonts.lato(
                              fontWeight: FontWeight.w500,
  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      case TaskStatus.notDone:
        icon = Icons.clear;
        color = Colors.red;
        statusText = Constants.not_done_key.tr;
        break;
      case TaskStatus.inProgress:
        icon = Icons.access_time;
        color = Colors.orange;
        statusText = Constants.in_progress_key.tr;
        break;
      case TaskStatus.done:
        icon = Icons.check;
        color = Colors.green;
        statusText = Constants.done_key.tr;
      case TaskStatus.notstarted:
        icon = Icons.schedule;
        color = Colors.grey;
        statusText = Constants.not_started_key.tr;
        break;
    }
