                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              // TODO  fix this
                              Text("This error has been fixed"),
                              ...
                              buildLabel(
                                  "${Constants.description_key.tr}: ${widget.task.description ?? "no description"}"),
                              StreamBuilder(
                              ...
                              buildLabel(
                                  "${Constants.start_date_key.tr}:${formatDateTime(widget.task.startDate)}"),
                              buildLabel(
                                  "${Constants.end_date_key.tr}:${formatDateTime(widget.task.endDate!)}"),
                            ],
                          ),
                        ),
                      ),
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 20),
                            buildLabel(
                                "${Constants.description_key.tr}: ${widget.task.description}"),
                            StreamBuilder(
                              stream: statusController
                                  .getStatusByIdStream(
                                      idk: widget.task.statusId)
