...
import 'package:mytest/models/team/waiting_member_model.dart';
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppSpaces.verticalSpace10,
                      InBottomSheetSubtitle(
                        title: Constants.tap_the_logo_to_upload_new_file_key.tr,
                        alignment: Alignment.center,
                      ),
                      AppSpaces.verticalSpace20,
                      Padding(
                        ...
                        child: LabelledFormInput(
                            validator: (value) {
                              if (value!.isEmpty) {
                                return Constants.team_name_not_empty_key.tr;
                              }
                              return null;
                            },
                            autovalidateMode:
                            ...
                            placeholder:
                                Constants.enter_the_name_of_team_key.tr,
                            keyboardType: "text",
                            controller: teamNameCobtroller,
                            obscureText: false,
                            label: Constants.team_name_key.tr),
                      ),
                      AppSpaces.verticalSpace20,
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: LabelledSelectableContainer(
                            label: Constants.members_key.tr,
                            value: Constants.select_members_key.tr,
                            icon: Icons.add,
                      ...
                      AppPrimaryButton(
                        buttonHeight: 50,
                        buttonWidth: 180,
                        buttonText: Constants.create_new_team_key.tr,
                        callback: () async {
                            ...
                            try {
                              if (userController.users.isEmpty) {
                                CustomSnackBar.showError(
                                    Constants.choose_member_for_team_key.tr);
                              } else {
                                  ...
                                  resOfUpload.fold((left) {
                                    ...
                                    right.then((value) async {
                                      ...
                                      CustomSnackBar.showSuccess(
                                          "${Constants.create_team_key.tr} ${teamModel.name} ${Constants.completed_successfully_key.tr}");
                                    });
                                  });
                                } else {
                                  TeamModel teamModel = TeamModel(
