...
class _DailyGoalCardState extends State<DailyGoalCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: Utils.screenHeight2 * 0.2,
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            // AppSpaces.verticalSpace10,
            Text(
              //    "${Constants.you_marked_key.tr}  $first $second $message  ${Constants.are_done_key.tr}  ",
              "  $first  $message  ${Constants.are_done_key.tr}  ",
              style: GoogleFonts.lato(
                  color: HexColor.fromHex("616575"),
