        ...
        children: [
          ...
          SafeArea(
            child: TaskezAppHeader(
              title: Constants.sub_tasks_key.tr,
              widget: MySearchBarWidget(
                searchWord: Constants.sub_tasks_key.tr,
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Text(
                            Constants.no_sub_tasks_found_key.tr,
          ...
          addTask: (
            ...
            if (!startDate.isAfter(mainTask.startDate) ||
              ...
              CustomSnackBar.showError(
                  Constants.sub_task_dates_between_main_task_dates_key.tr);
              return;
            }
            UserModel userModel =
            ...
            if (overlapped) {
              ...
              Get.defaultDialog(
                  title: Constants.task_time_error_key.tr,
                  middleText:
                  ...
                  onConfirm: () async {
                    ...
                    await fcmNotifications.sendNotificationAsJson(
                        ...
                        title: Constants.you_have_a_task_key.tr,
                        data: {"id": waitingid},
                        body:
                    ...
                    CustomSnackBar.showSuccess(
                        "${Constants.task_key.tr} ${taskName}  ${Constants.sent_to_member_successfully_key.tr}");
