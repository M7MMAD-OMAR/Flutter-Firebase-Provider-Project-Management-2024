        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              StreamBuilder<DocumentSnapshot<UserModel>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return LabelledFormInput(
                        ...
                        obscureText: false,
                        label: Constants.team_manager_key.tr);
                  }),
              AppSpaces.verticalSpace10,
              Form(
                key: formKey,
              ...
              AppSpaces.verticalSpace10,
              ContainerLabel(label: Constants.members_key.tr),
              AppSpaces.verticalSpace10,
              Transform.scale(
              ...
              Row(
                ...
                children: [
                  PrimaryProgressButton(
                    height: 50,
                    width: 150,
                    label: Constants.edit_team_key.tr,
                    callback: () async {
                        ...
                        if (name != widget.teamModel.name) {
                          ...
                          if (res) {
                            ...
                            CustomSnackBar.showSuccess(
                                Constants.team_updated_successfully_key.tr);
                            Navigator.of(context).pop();
                          }
                          Get.key.currentState!.pop();
                        }
