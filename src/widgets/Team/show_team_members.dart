          ...
          child: Column(children: [
            Padding(
              ...
              child: TaskezAppHeader(
                title: Constants.members_key.tr,
                        ...
                        return GestureDetector(
                          onTap: () {
                            CustomDialog.userInfoDialog(
                                title: Constants.team_leader_key.tr,
...
//
                                                                            ...
                                                                            SlidableAction(
                                                                              ...
                                                                              onPressed: (context) {
                                                                                ...
                                                                                CustomDialog.showConfirmDeleteDialog(
                                                                                    ...
                                                                                    content: Text("${Constants.confirm_delete_key.tr} ${snapshotUsers.data!.docs[index].data().name} ${Constants.from_this_team_key.tr}"));
                                                                              },
                                                                              label: Constants.delete_key.tr,
                                                                ...
                                                                : Visibility(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        CustomDialog.userInfoDialog(
                                                                            title:
                                                                                Constants.invited_not_a_member_yet_key.tr,
            ...
            Visibility(
              ...
              child: AppPrimaryButton(
                  buttonHeight: 50,
                  buttonWidth: 150,
                  buttonText: Constants.add_member_key.tr,
                  callback: () {
                    Get.to(
                      () => SearchForMembers(
                        teamModel: teamModel,
