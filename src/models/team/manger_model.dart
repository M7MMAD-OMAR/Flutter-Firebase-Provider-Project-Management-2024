...
class ManagerModel with TopModel {
  ...
  set setCreatedAt(DateTime createdAtParameter) {
    ...
    if (createdAtParameter.isBefore(now)) {
      exception =
          Exception(Constants.manager_creating_time_before_now_invalid_key.tr);
      throw exception;
    }
    ...
    if (createdAtParameter.isAfter(now)) {
      exception = Exception(
          Constants.manager_creating_time_not_in_future_invalid_key.tr);
      throw exception;
    }
  ...
  set setId(String idParameter) {
    ...
    if (idParameter.isEmpty) {
      exception = Exception(Constants.manager_id_empty_key.tr);
      throw exception;
    }
  ...
  set setUpdatedAt(DateTime updatedAtParameter) {
    ...
    if (updatedAtParameter.isBefore(createdAt)) {
      exception =
          Exception(Constants.updating_time_before_creating_invalid_key.tr);
      throw exception;
    }
    updatedAt = updatedAtParameter;
  }
