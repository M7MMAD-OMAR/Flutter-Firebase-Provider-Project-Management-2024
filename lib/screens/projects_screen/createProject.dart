...
import '../../widgets/bottom_sheets/bottom_sheet_holder.dart';
...
class _CreateProjectState extends State<CreateProject> {
  ...
  void _showImagePickerDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(Constants.choose_an_image_key.tr),
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                GestureDetector(
                  child: Text(Constants.camera_key.tr),
                  onTap: () {
                ...
                GestureDetector(
                  child: Text(Constants.gallery_key.tr),
                  onTap: () {
                ...
                const Padding(padding: EdgeInsets.all(8.0)),
                GestureDetector(
                  child: Text(Constants.cancel_key.tr),
                  onTap: () {
                    Navigator.of(context).pop();
                  },
                ),
          ...
          Padding(
            ...
            child:
                                ...
                                return buildStackedImagesOfTeams(
                                    ...
                                    onTap: () {
                                      Get.to(() => SelectMyTeamScreen(
                                          title: Constants.choose_team_key.tr));
                                    },
                                    teams: <TeamModel?>[]);
                              } else {
                                return Obx(
                ...
                children: [
                  ...
                  Expanded(
                    child: LabelledFormInput(
                      validator: (value) {
                        if (value!.isEmpty) {
                          return Constants.name_can_not_be_empty_key.tr;
                        }
                        if (value.isNotEmpty) {
                          if (isTaked) {
                            return Constants
                      ...
                      label: Constants.name_key.tr,
                      readOnly: false,
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      placeholder: Constants.project_name_key.tr,
                      keyboardType: "text",
              ...
              LabelledFormInput(
                validator: (p0) {
                  if (p0!.isEmpty) {
                    return Constants.description_cannot_be_empty_spaces_key.tr;
                  }
                  return null;
                },
                onChanged: (p0) {
                ...
                label: Constants.description_key.tr,
                readOnly: false,
                autovalidateMode: AutovalidateMode.onUserInteraction,
                placeholder: Constants.project_description_key.tr,
                keyboardType: "text",
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                NewSheetGoToCalendarWidget(
                  ...
                  label: Constants.start_date_key.tr,
                ),
                NewSheetGoToCalendarWidget(
                  ...
                  label: Constants.due_date_validation_key.tr,
                )
              ]),
              // Spacer(),
              AppSpaces.verticalSpace20,
                    ...
                    if (formKey.currentState!.validate()) {
                      if (addTeamToCreatProjectScreen.teams.isNotEmpty) {
                        ...
                        MySnackBar.showError(
                            Constants.choose_team_first_for_project_key.tr);
                      }
                    }
                    print("sadsda");
                  },
  ...
  String formatDateTime(DateTime dateTime) {
    ...
    if (dateTime.year == now.year &&
      ...
      return "${Constants.today_key.tr} ${DateFormat('h:mma').format(dateTime)}";
    } else {
  ...
  Future<void> addProject() async {
    ...
    if (startDate.isAfter(dueDate) ||
      ...
      print("step 1");
      MySnackBar.showError(Constants
    ...
    if (widget.isEditMode == false) {
      try {
        ...
        if (selectedImagePath != null) {
          ...
          final resOfUpload = await uploadImageToStorge(
            ...
            imageName: name,
            folder: Constants.projects_key.tr,
          );
          resOfUpload.fold((left) {
            ...
            right.then((value) async {
              ...
              MySnackBar.showSuccess(
                  "${Constants.create_project_key.tr} $name ${Constants.completed_successfully_key.tr}");
            });
          });
        } else {
          ProjectModel projectModel = ProjectModel(
      ...
      // MySnackBar.showSuccess("task $name Updated successfully");
      // Get.key.currentState!.pop();
    }
  }
}
