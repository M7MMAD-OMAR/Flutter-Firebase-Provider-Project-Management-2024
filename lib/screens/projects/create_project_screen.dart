...
class _CreateProjectScreenState extends State<CreateProjectScreen> {
  ...
  final AddTeamToCreatProjectProvider addTeamToCreatProjectScreen =
      Provider.of<AddTeamToCreatProjectProvider>(navigatorKey.currentContext!,
          listen: false);
  ...
  ProjectProvider projectController =
      Provider.of<ProjectProvider>(navigatorKey.currentContext!, listen: false);
  TeamProvider teamController =
      Provider.of<TeamProvider>(navigatorKey.currentContext!, listen: false);
  TeamMemberProvider teamMemberController = Provider.of<TeamMemberProvider>(
      navigatorKey.currentContext!,
      listen: false);
  ManagerProvider managerController =
      Provider.of<ManagerProvider>(navigatorKey.currentContext!, listen: false);
                ...
                AddSubIcon(
                  ...
                  callback: () async {
                    if (formKey.currentState!.validate()) {
                      ...
                      CustomSnackBar.showError("الاسم");
                      // }
                    }
                  },
                ),
  ...
  Future<void> addProject() async {
    ...
    if (widget.isEditMode == false) {
      try {
        ...
        CustomSnackBar.showError(
            e.toString() + "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj");
      }
    } else {
