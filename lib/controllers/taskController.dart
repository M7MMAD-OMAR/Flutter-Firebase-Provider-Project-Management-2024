...
import '../models/tops/var2_top_model.dart';
...
//! TODO make this func work
  ...
  Future<List<Object?>?> getTasksForAnImportance<t extends TopModel>({
    ...
    Exception exception;
    if (importance < 1) {
      exception = Exception(Constants.importance_min_value_error_key);
      throw exception;
    }
    if (importance > 5) {
      exception = Exception(Constants.importance_max_value_error_key);
      throw exception;
    }
    return await getListDataWhereAndWhere(
      collectionReference: reference,
