...
//جلب جميع المهام التي لها نفس النوع
  ...
  Future<void> addCategory(UserTaskCategoryModel taskCategoryModel) async {
    ...
    exception = Exception(Constants.Sorry_the_user_id_cannot_be_found_key.tr);
    throw exception;
  }
...
//تحديث نوع المهام
  updateCategory(
    ...
    await updateRelationalFields(
      ...
      nameException: Exception(Constants.category_already_been_added_key.tr),
    );
  }
