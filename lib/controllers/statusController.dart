...
class StatusController extends TopController {
  ...
  Future<void> addStatus(StatusModel statusModel) async {
    ...
    bool exist = await existByOne(
        ...
        field: nameK);
    if (exist) {
      throw exception = Exception(Constants.status_name_already_added_key.tr);
    }
  ...
  Future<void> updateStatus(StatusModel statusModel) async {
    ...
    if (snapshot == null) {
      ...
      exception = Exception(Constants.status_name_already_added_key.tr);
      throw exception;
    }
  }
  ...
  Future<void> updateStatus2(
    ...
    if (data.containsKey(id)) {
      exception = Exception(Constants.status_id_update_error_key.tr);
      throw exception;
    }
    ...
    await updateNonRelationalFields(
        ...
        data: data,
        id: id,
        nameException: Exception(Constants.status_already_added_key.tr));
  }
}
