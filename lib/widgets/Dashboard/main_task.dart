                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${widget.completed.toInt()} ${AppConstants.out_of_key.tr} ${widget.all.toInt()} ${AppConstants.is_completed_key.tr}',
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppSpaces.verticalSpace10,
                          Text(
                            '${widget.completed.toInt()}  ${widget.all.toInt()}  ${AppConstants.is_completed_key.tr}',
                            // Use the rating property of taskModel
                            style: GoogleFonts.lato(
                              fontWeight: FontWeight.w500,
