...
class ProjectSubTaskModel extends TaskClass {
  ...
  set setAssignedTo(String assignedToParameter) {
    ...
    if (assignedToParameter.isEmpty) {
      exception = Exception(Constants.team_member_assigned_id_empty_error_key);
      throw exception;
    }
  ...
  set setMainTaskId(String mainTaskIdParameter) {
    ...
    if (mainTaskIdParameter.isEmpty) {
      exception = Exception(Constants.sub_task_main_task_id_empty_error_key);
      throw exception;
    }
  ...
  set setprojectId(String projectIdParameter) {
    ...
    if (projectIdParameter.isEmpty) {
      exception = Exception(Constants.sub_task_project_id_empty_error_key);
      throw exception;
    }
  ...
  set setId(String idParameter) {
    ...
    if (idParameter.isEmpty) {
      exception = Exception(Constants.project_sub_task_id_empty_error_key);
      throw exception;
    }
    id = idParameter;
  }
  ...
  set setName(String? nameParameter) {
    ...
    if (nameParameter == null) {
      exception = Exception(Constants.project_sub_task_name_null_error_key);
      throw exception;
    }
    //لا يمكن أن يكون اسم المهمة الفرعية في المشروع فارغاُ
    if (nameParameter.isEmpty) {
      exception = Exception(Constants.project_sub_task_name_empty_error_key);
      throw exception;
    }
  ...
  set setStatusId(String statusIdParameter) {
    ...
    if (statusIdParameter.isEmpty) {
      exception =
          Exception(Constants.project_sub_task_status_id_empty_error_key);
      throw exception;
    }
  ...
  set setImportance(int importanceParameter) {
    ...
    if (importanceParameter < 1) {
      exception =
          Exception(Constants.project_sub_task_importance_min_error_key);
      throw exception;
    }
    //لا يمكن أن تكون للأهمية قيمة أكبر من 5
    if (importanceParameter > 5) {
      exception =
          Exception(Constants.project_sub_task_importance_max_error_key);
      throw exception;
    }
    importance = importanceParameter;
  }
  ...
  set setCreatedAt(DateTime createdAtParameter) {
    ...
    if (createdAtParameter.isAfter(now)) {
      exception =
          Exception(Constants.project_sub_task_create_time_future_error_key);
      throw exception;
    }
    ...
    if (firebaseTime(createdAtParameter).isBefore(now)) {
      exception =
          Exception(Constants.project_sub_task_create_time_past_error_key);
      throw exception;
    }
  ...
  set setUpdatedAt(DateTime updatedAtParameter) {
    ...
    if (updatedAtParameter.isBefore(createdAt)) {
      exception = Exception(
          Constants.project_sub_task_update_time_before_creating_error_key);
      throw exception;
    }
  ...
  set setStartDate(DateTime? startDateParameter) {
    ...
    if (startDateParameter == null) {
      exception =
          Exception(Constants.project_sub_task_start_date_null_error_key);
      throw exception;
    }
    ...
    if (startDateParameter.isBefore(now)) {
      exception =
          Exception(Constants.project_sub_task_start_date_past_error_key);
      throw exception;
    }
  ...
  set setEndDate(DateTime? endDateParameter) {
    ...
    if (endDateParameter == null) {
      exception = Exception(Constants.project_sub_task_end_date_null_error_key);
      throw exception;
    }
    ...
    if (endDateParameter.isBefore(startDate)) {
      exception =
          Exception(Constants.project_sub_task_start_after_end_error_key);
      throw exception;
    }
    ...
    if ((endDateParameter).isAtSameMomentAs(getStartDate)) {
      exception = Exception(
        Constants.project_sub_task_start_same_as_end_error_key,
      );
      throw exception;
    }
    ...
    if (diff.inMinutes < 5) {
      exception =
          Exception(Constants.project_sub_task_time_difference_error_key);
      throw exception;
    }
